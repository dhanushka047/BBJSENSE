...
INSERT INTO "new_Device" ("approval_status", "approved_by", "created_at", "id", "is_online", "last_seen_at", "mac_address", "modbus_address", "name", "nickname", "owner_id", "updated_at") SELECT "approval_status", "approved_by", "created_at", "id", "is_online", "last_seen_at", "mac_address", "modbus_address", "name", "nickname", "owner_id", "updated_at" FROM "Device";
DROP TABLE "Device";
